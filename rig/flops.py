...
_STRUCTURAL = frozenset(
    {
        ...
        "convert_element_type", "copy", "device_put", "rev", "pad", "gather",
        "scatter", "scatter-add", "scatter_add", "iota", "split", "select_and_scatter",
        "bitcast_convert_type", "stop_gradient", "reduce_precision", "sharding_constraint",
        "squeeze_p", "tie_in", "empty", "opt_barrier", "optimization_barrier",
        "stack", "unstack", "select_and_gather_add", "clone",
    }
)
...
_ELEMENTWISE = frozenset(
    {
        "add", "add_any", "sub", "mul", "div", "neg", "exp", "exp2", "expm1",
        "log", "log1p", "tanh", "logistic", "erf", "erfc", "erf_inv", "rsqrt",
        "sqrt", "cbrt", "pow", "integer_pow", "max", "min", "select_n", "and",
        "or", "not", "xor", "eq", "ne", "lt", "le", "gt", "ge", "sign", "abs",
        "floor", "ceil", "round", "rem", "nextafter", "clamp", "square",
        "logaddexp", "sin", "cos", "tan", "asin", "acos", "atan", "atan2",
        "sinh", "cosh", "asinh", "acosh", "atanh", "is_finite", "real", "imag",
        "conj", "complex", "shift_left", "shift_right_logical",
        "shift_right_arithmetic", "population_count", "clz", "reduce_sum",
        "reduce_max", "reduce_min", "reduce_prod", "reduce_and", "reduce_or",
        "reduce_xor", "argmax", "argmin", "cumsum", "cumlogsumexp", "cummax",
        "cummin", "cumprod", "sort", "top_k", "random_bits", "random_seed",
        "random_wrap", "random_unwrap", "random_fold_in", "threefry2x32",
        "erf_inv_p", "rng_uniform", "rng_bit_generator", "nextafter_p",
    }
)
...
_TRANSPARENT = frozenset(
    {
        "jit", "pjit", "closed_call", "core_call", "remat", "remat2", "checkpoint",
        "custom_vjp_call", "custom_vjp_call_jaxpr", "custom_jvp_call",
        "custom_jvp_call_jaxpr", "custom_lin", "custom_transpose_call",
        "named_call", "run_state", "linear_call",
    }
)
