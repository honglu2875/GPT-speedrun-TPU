        ...
        blocks.append(
            {
                ...
                "mlp_gate_up_w": normal(rng, (d_model, 2 * hidden), 0.02),
                "mlp_gate_up_b": np.zeros((2 * hidden,), dtype=np.float32),
...
def gpt_hidden(
    ...
    for block in params["blocks"]:
        ...
        gate_up = linear(
            x_norm, block["mlp_gate_up_w"], block["mlp_gate_up_b"], dtype
        )
    ...
    console.table(
        ...
        (
            ...
            (
                ...
                f"RoPE RMSNorm SwiGLU-{config.mlp_hidden}",
            ),
