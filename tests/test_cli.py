...
class CliTests(unittest.TestCase):
    ...
    def test_wizard_accepts_defaults_and_returns_complete_config(self) -> None:
        ...
        # prompt, and three confirmations. Dataset preparation is automatic.
        with patch("builtins.input", side_effect=[""] * 12) as prompt:
        ...
        self.assertEqual(prompt.call_count, 12)
