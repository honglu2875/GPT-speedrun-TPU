...
selected dataset. Dataset preparation is part of `make prepare`; only the
explicit CLI flag `--no-download` skips it. Personal choices are stored in the gitignored
